...
export const showInfoDialog = (preOfferAnswer, description) => {
    let infoDialog = null;
    if (description) {
        infoDialog = element.getInfoDialog(preOfferAnswer, description);
    } else {
...
export const setMessagingReady = (ready) => {
    const input = document.getElementById('new_message_input');
